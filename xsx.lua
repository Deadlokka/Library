...
function library:Watermark(text)
    ...
    edge.Position = UDim2.new(0, 100, 0, -25)
    ...
    background.Position = UDim2.new(0, 100, 0, -25)
...
function library:Introduction()
    ...
    xsxLogo.Image = "http://www.roblox.com/asset/?id=85759875454276"
    ...
    hashLogo.Image = "http://www.roblox.com/asset/?id=9365069861"  -- mark
